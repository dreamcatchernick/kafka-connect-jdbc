 ...
 */
public class DebeziumOracleDialect extends GenericDatabaseDialect {

    /**
     * The provider for {@link DebeziumOracleDialect}.
     */
    public static class Provider extends SubprotocolBasedProvider {
        public Provider() {
            super(DebeziumOracleDialect.class.getSimpleName(), "debeziumoracle");
        }

        @Override
        public DatabaseDialect create(AbstractConfig config) {
            return new DebeziumOracleDialect(config);
        }
    }
     ...
     */
    public DebeziumOracleDialect(AbstractConfig config) {
